...
const SUBGRAPH_URLS: Record<string, { decentralized: string }> = {
  ...
  "8453": {
    decentralized:
      "https://gateway.thegraph.com/api/[api-key]/subgraphs/id/2u4mWUV4xS19ef1MbnxZHWLLMwdPxtVifH46JbonXwXP",
  },
};
...
function transformMarketsToTags(chainId: string, markets: Market[]): ContractTag[] {
  ...
  return validTokens.map((token) => {
    ...
    return {
      ...
      "Project Name": "Seamless",
      "UI/Website Link": "https://www.seamlessprotocol.com/",
      "Public Note": `Seamless' official ${token.name} token contract.`,
    };
  });
}
